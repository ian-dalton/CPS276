...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'iadalton';//this will be your WCC username
      $dbUsr = 'iadalton';//this will be your WCC username
      $dbPass = '39ffdrab8wVA';//this will be the password found in the video.
